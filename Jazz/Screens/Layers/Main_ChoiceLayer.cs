...
namespace Jazz.Screens.Layers
{
    ...
    /// 
    /// </summary>
    public class Main_ChoiceLayer : Layer
    {
        public Main_ChoiceLayer(Game game)
            : base(game)
        {
        ...
        {
            base.Initialize();
            m_gameLayerType = Constants.GameLayers.MAIN_CHOICE;
        ...
        {
            m_lMenuItems[0].Draw(gameTime, m_vStart - new Vector2(GraphicsDevice.Viewport.Width / 4, 0.0f));
            m_lMenuItems[1].Draw(gameTime, m_vStart + new Vector2(GraphicsDevice.Viewport.Width / 4, 0.0f));
            base.Draw(gameTime);
        }
        ...
        {
            m_lMenuItems.Add(new MenuItems.Main_Choice_LanItem(Game));
            m_lMenuItems.Add(new MenuItems.Main_Choice_OnlineItem(Game));
